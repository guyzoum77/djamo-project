...
class FormTaskWidget extends StatefulWidget {
  const FormTaskWidget({super.key});
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Container(
                ...
                child: const Text("Ajouter une tâche", style: TextStyle(color: AppColorsUtils.kBlackColor, fontWeight: FontWeight.bold, fontSize: 19)),
              ),
              elevation: 0.3,
              leading: Container(
                  width: 20,
